...
public interface TheLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TheLangParser#declArray}.
	 * @param ctx the parse tree
	 */
	void enterDeclArray(TheLangParser.DeclArrayContext ctx);
	/**
	 * Exit a parse tree produced by {@link TheLangParser#declArray}.
	 * @param ctx the parse tree
	 */
	void exitDeclArray(TheLangParser.DeclArrayContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TheLangParser#assignArrayStmt}.
	 * @param ctx the parse tree
	 */
	void enterAssignArrayStmt(TheLangParser.AssignArrayStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link TheLangParser#assignArrayStmt}.
	 * @param ctx the parse tree
	 */
	void exitAssignArrayStmt(TheLangParser.AssignArrayStmtContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TheLangParser#readArrayStmt}.
	 * @param ctx the parse tree
	 */
	void enterReadArrayStmt(TheLangParser.ReadArrayStmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link TheLangParser#readArrayStmt}.
	 * @param ctx the parse tree
	 */
	void exitReadArrayStmt(TheLangParser.ReadArrayStmtContext ctx);
	/**
