...
import dk.dtu.student.programanalysis.implementation.analysis.AnalysisType;
 ...
 */
public abstract class GeneralAnalysis {
    ...
    protected abstract AnalysisType getExtremeValue(Set<? extends Label> labels);

    protected abstract AnalysisType getBottomValue();

    protected abstract AnalysisType analyseComponent(Label l);

    protected abstract AnalysisType getAnalysisResult(Label l);

    protected abstract void setAnalysisResult(Label l, AnalysisType newSet);
